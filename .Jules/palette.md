...
## 2026-04-16 - Disable Inputs on Connection State
...
**Action:** Always disable inputs during disconnected/connecting states and use pseudo-classes appropriately to prevent misleading UI feedback.
