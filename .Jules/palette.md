...
## 2026-04-02 - Disable inputs during WS transition
**Learning:** Visually and programmatically disabling interactive elements during connection limits user confusion and prevents errors.
**Action:** Use CSS :not(:disabled) and update placeholder states dynamically.
