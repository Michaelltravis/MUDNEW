...
<body>
    ...
    <script>
        ...
        function setControlsDisabled(disabled, placeholder) {
        ...
        function connect() {
            ...
            setControlsDisabled(true, 'Connecting...');
            ...
            ws.onopen = () => {
                ...
                setControlsDisabled(false, 'Enter command...');
            };
            ...
            ws.onclose = () => {
                ...
                setControlsDisabled(true, 'Disconnected');
            };
