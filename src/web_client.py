            ...
            <div class="modal-body">
                <div class="setting-group">
                    ...
                    <div class="setting-control">
                        <button class="setting-btn" id="font-decrease" aria-label="Decrease font size" title="Decrease font size">A-</button>
                        <span id="font-size-display" aria-live="polite">14px</span>
                        <button class="setting-btn" id="font-increase" aria-label="Increase font size" title="Increase font size">A+</button>
                    </div>
                </div>
                <div class="setting-group">
