...
<body>
    ...
    <script>
        ...
        function applySettings() {
            ...
            // Sync disabled state of font size stepper buttons with boundary limits
            const fontDecreaseBtn = document.getElementById('font-decrease');
            const fontIncreaseBtn = document.getElementById('font-increase');
            if (fontDecreaseBtn) fontDecreaseBtn.disabled = settings.fontSize <= 10;
            if (fontIncreaseBtn) fontIncreaseBtn.disabled = settings.fontSize >= 24;
