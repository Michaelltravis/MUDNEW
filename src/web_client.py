...
<body>
    ...
    <script>
        ...
        function setControlsState(disabled, placeholder) {
        ...
        function connect() {
            ...
            setControlsState(true, 'Connecting...');
            const protocol = location.protocol === 'https:' ? 'wss:' : 'ws:';
            ws = new WebSocket(`${protocol}//${location.host}/ws`);
            
            ws.onopen = () => {
                setStatus('', 'Connected');
                setControlsState(false, 'Enter command...');
            ...
            ws.onclose = () => {
                ...
                setControlsState(true, 'Disconnected. Refresh to reconnect.');
                appendOutput('<span class="ansi-yellow">\\n--- Connection closed. Refresh to reconnect. ---\\n</span>');
            };
            
            ws.onerror = () => {
                setStatus('disconnected', 'Error');
                setControlsState(true, 'Connection failed. Is the server running?');
