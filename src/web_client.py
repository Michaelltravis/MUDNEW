...
<body>
    ...
    <script>
        ...
        function setInteractionDisabled(disabled, placeholderText) {
            if (input) {
        ...
        function connect() {
            ...
            setInteractionDisabled(true, 'Connecting...');
            ...
            ws.onopen = () => {
                ...
                setInteractionDisabled(false, 'Enter command...');
            };
            ...
            ws.onclose = () => {
                ...
                setInteractionDisabled(true, 'Disconnected');
