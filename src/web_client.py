...
<body>
    ...
    <script>
        ...
        function setInteractive(enabled, placeholder) {
            const input = document.getElementById('command-input');
            const sendBtn = document.getElementById('send-btn');
        ...
        function connect() {
            ...
            setInteractive(false, 'Connecting...');
            ...
            ws.onopen = () => {
                ...
                setInteractive(true, 'Enter command...');
