...
<body>
    ...
    <script>
        ...
        function applySettings() {
            ...
            document.getElementById('autoscroll-toggle').setAttribute('aria-checked', settings.autoScroll);
            ...
            document.getElementById('echo-toggle').setAttribute('aria-checked', settings.echo);
            ...
            document.getElementById('sound-toggle').setAttribute('aria-checked', settings.sound);
            ...
            document.getElementById('timestamp-toggle').setAttribute('aria-checked', settings.timestamps);
        }
