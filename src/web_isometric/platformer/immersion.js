...
(() => {
  ...
  const PROP_FLAVOR = {
    ...
    campfire: ['A Campfire', 'Embers pop and settle in a ring of blackened stones. The warmth invites you to rest a while.'],
    well: ['A Stone Well', 'Cold, clean water waits far below. A frayed rope vanishes into the dark, and your reflection waits at the bottom.'],
    altar: ['An Altar', 'Candle-stubs and old offerings crowd the worn slab. The air here feels watched, and faintly holy.'],
