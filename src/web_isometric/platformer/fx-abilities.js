...
(() => {
  ...
  add(/\bsmite\b|censure|dawnhammer|hammer.?of.?justice|crusader.?strike|crusaders.?judgment|verdict.?of.?the.?order|order.?verdict|templars.?verdict|judgment|seal.?of/i, 'ranged', (s, c, x, y) => { MH.fx.boltFromSky(s, x, y, P().holy); MH.fx.glowFlash(s, x, y - 6, P().holy.a, 0.7); glyph(s, x, y, '✟', P().holy.a); sound('holy', 2); });
